    ...
    <section className="flex custom-container gap-8 flex-col w-full items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-6">
        ...
        <article className="flex max-md:order-1 flex-col items-start gap-5">
          <h3 className="text-sm text-start uppercase text-[#9E9E9E] font-mon">
          ...
          <div className="flex items-center gap-2">
            <Button
              asChild
              className="font-medium font-dm text-sm sm:text-base text-white h-11 rounded-4xl px-6 w-max bg-main-blue hover:border-main-blue border border-transparent transition-colors hover:bg-white hover:text-main-blue group"
            >
            ...
            <Button
              asChild
              className="font-medium font-dm text-sm sm:text-base h-11 rounded-4xl text-main-blue w-max  px-6! bg-[#E7E9EE] hover:border-[#E7E9EE] border border-transparent transition-colors hover:bg-white hover:text-main-blue group"
            >
