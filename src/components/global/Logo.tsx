export function LogoSvg({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M11.2377 20.7178C10.4737 19.9026 9.91718 18.8917 9.65228 17.7689L0.855713 20.1179L1.70167 23.2643L11.2377 20.7178Z"
        fill="#979797"
      />
    </svg>
  );
  ...
  return (
    <div className="inline-flex relative gap-2 items-center">
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <circle cx="4.5" cy="4.5" r="3.25" stroke="#979797" strokeWidth="2.5" />
      </svg>
    </div>
  );
}
