    ...
    <>
      <SignedOut>
        <div className="flex items-center gap-3">
          <Button
            asChild
            className="font-medium font-dm text-base h-11 rounded-4xl text-main-blue lg:flex hidden px-8 bg-[#E7E9EE] hover:border-[#E7E9EE] border border-transparent transition-colors hover:bg-white hover:text-main-blue group"
          >
          ...
          <Button
            asChild
            className="font-medium font-dm text-base text-white h-11 rounded-4xl lg:flex hidden px-8 bg-main-blue hover:border-main-blue border border-transparent transition-colors hover:bg-white hover:text-main-blue group"
          >
